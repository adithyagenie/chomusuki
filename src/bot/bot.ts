...
export async function botinit(bot:Bot<Context & ConversationFlavor>, updater:UpdateHold, authchat:number) {
...
module.exports = { UpdateHold, botinit, syncresponser, bot }
